...
team2_user1 = TeamsUser.where(team: team2, user: user1).first_or_create(team: team2, user: user1)
team2_user2 = TeamsUser.where(team: team2, user: user2).first_or_create(team: team2, user: user2)
team2_user3 = TeamsUser.where(team: team2, user: user3).first_or_create(team: team2, user: user3)
team2_user4 = TeamsUser.where(team: team2, user: user4).first_or_create(team: team2, user: user4)
team3_user1 = TeamsUser.where(team: team3, user: user1).first_or_create(team: team3, user: user1)
team3_user2 = TeamsUser.where(team: team3, user: user2).first_or_create(team: team3, user: user2)
team3_user3 = TeamsUser.where(team: team3, user: user3).first_or_create(team: team3, user: user3)
team3_user4 = TeamsUser.where(team: team3, user: user4).first_or_create(team: team3, user: user4)
team4_user1 = TeamsUser.where(team: team4, user: user1).first_or_create(team: team4, user: user1)
team4_user2 = TeamsUser.where(team: team4, user: user2).first_or_create(team: team4, user: user2)
team4_user3 = TeamsUser.where(team: team4, user: user3).first_or_create(team: team4, user: user3)
team4_user4 = TeamsUser.where(team: team4, user: user4).first_or_create(team: team4, user: user4)
